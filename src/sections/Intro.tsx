...
export default function Intro() {
  ...
  return (
    <div
      className="flex flex-col lg:flex-row justify-between bg-[--primary] pt-5"
    ...
    >
      ...
      >
        ...
        <div className="text-lg sm:text-2xl text-center px-10">
          ...
          skincare fun, easy, and effective. Explore our products and find your
          perfect match!
        </div>
        <Link
          to={"/products"}
      ...
      <div className="max-lg:flex max-lg:justify-center opacity-0" ref={image}>
